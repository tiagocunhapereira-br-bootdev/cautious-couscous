...
import { createFeed, getFeeds, User, Feed, getFeedByURL } from "./lib/db/queries/feeds.js";
import { feedFollows, feeds, users } from "./lib/db/schema.js";
import { read } from "fs";
...
async function removeFeedFollow(userId: string, feedId: string): Promise<void> {
    await db
        .delete(feedFollows)
